        ...
        GroupBox {
            ...
            GridLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        if (!pki.decrypt(inbuf.text, inpub_label.text, inpriv_label.text)) {
                            notifDialog.setMsgLabel("Gagal dekripsi teks")
                        } else {
                            notifDialog.setMsgLabel("Dekripsi teks berhasil")
                        }
                        notifDialog.open()
                    }
                }
